...
class feroxbuster(HttpFuzzer):
    ...
    opts = {
        ...
        "extract_links": {
            "is_flag": True,
            "default": False,
            "help": "Extract links from response body",
        },
        "collect_backups": {
            "is_flag": True,
            "default": False,
            "help": "Request likely backup exts for urls",
        },
        "collect_extensions": {
            "is_flag": True,
            "default": False,
            "help": "Discover exts and add to --extensions",
        },
        "collect_words": {
            "is_flag": True,
            "default": False,
            "help": "Discover important words and add to wordlist",
        },
    }
    opt_key_map = {
        HEADER: "headers",
    ...
    if platform.system() == "Darwin":
        install_cmd = "brew install feroxbuster"
    else:
        install_cmd = (
